...
export default function UI({}) {
  ...
  const ITEMS_MAP = [
    { id: 1, cost: 200, name: 'Lich King Sword', image: 'https://cdn.discordapp.com/attachments/371115539365494794/1216243141296914432/il_570xN.png?ex=65ffadb1&is=65ed38b1&hm=1f39c8935a44029669b98b238476b0b0527b3b38ded791244a73b2ef0b9c4c64&' },
    { id: 2, cost: 30, name: 'Link Kit', image: 'https://cdn.discordapp.com/attachments/371115539365494794/1216243316409241750/1_51e42ba9-bb2a-4d76-bd31-2e3e9125b043_1200x.png?ex=65ffaddb&is=65ed38db&hm=f0d74a63a49f6c79f495143cd90e4e98552d43b7fcf1c288f1a11c6ae057f092&' },
    { id: 3, cost: 150, name: 'Omnitrix', image: 'https://cdn.discordapp.com/attachments/371115539365494794/1216243518641672302/ben-10-omnitrix-3d-model-83155920b5.png?ex=65ffae0b&is=65ed390b&hm=9aefefd4c18fb88da3c60fe16e71a9358d73ef116660540baa95945f6a013e57&' },
    { id: 4, cost: 25, name: 'Levi Gear', image: 'https://cdn.discordapp.com/attachments/371115539365494794/1216243824943304725/DSC05199-12.png?ex=65ffae54&is=65ed3954&hm=be899a93ee994773b52e7ffa85e356309c61b8c40d803ef498d534a2a4b4c2cf&'},
    {id: 5, cost: 35, name: 'Kaiba Duel Disk', image: 'https://cdn.discordapp.com/attachments/371115539365494794/1216243947253399612/Battle20City20Duel20Disk201.png?ex=65ffae71&is=65ed3971&hm=b9a22ef0763703a0f02fc0f891e89ae3e261fd846a9e3fe9e314d8b84e0c1da9&'}
  ];
  ...
  const handleEquip = (item) => {
    console.log(`Equipping ${item.name} with id ${item.id}`);
    setEquipItem(item);
  }
  // END Giang's stuff
